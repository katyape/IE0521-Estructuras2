...
cout << "Overall miss rate: " << ((float)(prueba_cache->store_misses+prueba_cache->load_misses)/(float)(prueba_cache->store_misses+prueba_cache->store_hits+prueba_cache->load_misses+prueba_cache->load_hits)) <<'\n';
}
